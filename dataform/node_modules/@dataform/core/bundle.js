...
const dataform = $root.dataform = (() => {
    ...
    dataform.Table = (function() {
        ...
        Table.toObject = function toObject(message, options) {
            ...
            if (message.enumType != null && message.hasOwnProperty("enumType"))
                object.enumType = options.enums === String ? $root.dataform.TableType[message.enumType] : message.enumType;
            return object;
        };
...
function tableTypeStringToEnum(type, throwIfUnknown) {
    switch (type) {
        case "table":
...
function tableTypeEnumToString(enumType) {
...
class BigQueryAdapter extends Adapter {
    ...
    createOrReplace(table) {
        ...
        return `create or replace ${table.materialized
            ? "materialized "
            : ""}${this.tableTypeAsSql(this.baseTableType(table.enumType))} ${this.resolveTarget(table.target)} ${table.bigquery && table.bigquery.partitionBy
            ...
            if (table.enumType === dataform.TableType.INLINE) {
                Table.INLINE_IGNORED_PROPS.forEach(ignoredProp => {
                    if (objectExistsOrIsNonEmpty(table[ignoredProp])) {
                        this.compileError(`Unused property was detected: "${ignoredProp}". This property is not used for tables with type "inline" and will be ignored`, table.fileName, table.target);
                    }
                });
            }
        });
